...
#define CONFIG_SYS_CLK_FREQ     432000000       /* Arm Clock frequency */
...
#define CONFIG_USBD_MANUFACTURER       "SC"
#define CONFIG_USBD_PRODUCT_NAME       "DARLO"
...
#define CONFIG_SYS_PROMPT	"Darlo# "	/* Monitor Command Prompt */
